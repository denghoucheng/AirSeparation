	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"pageinfo\">跳转</a></li>\n");
			...
			for(int i=startTag; i<=totalPage && i<=endTag; i++){
				if(currentPage==i)
					sb.append("<li class=\"current\"><font color=red>"+i+"</font></li>\n");
				else
			...
			sb.append("	<li class=\"pageinfo\"><a>第<font color=red>"+currentPage+"</font>页</a></li>\n");
			sb.append("	<li><a>共<font color=red>"+totalPage+"</font>页</a></li>\n");
