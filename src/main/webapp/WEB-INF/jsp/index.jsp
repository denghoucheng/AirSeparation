...
$(document).ready(function(){
 ...
 function checkLogin(){
    $.get("${pageContext.request.contextPath}/checkLogin.html", function(data){
    	if("nologin" == data){
       		$.messager.confirm("系统提示","请重新登录！",function(r){
   		        if(r){
...
function modifyPassword(){
    $("#fm").form("submit",{
        ...
        onSubmit:function(){
            ...
            console.log(username+','+oldPassword+','+newPassword+','+newPassword2);
    ...
    <table style="padding: 5px; width:95%">
        <tr>
            ...
            <td valign="bottom" align="right" width="50%">
                <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-time'" style="width:180px;"><span id="sysTime" style="margin: auto;"></span></a>
                <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-man'" style="width:180px;"><font size="2">欢迎您：${user.username }</font></a>
                <a href="javascript:openPasswordModifyDialog()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" style="width:80px;">修改密码</a>
...
<div region="west" style="width: 200px;min-width:200px" title="导航菜单" split="true">
    <div id="div" class="easyui-accordion" data-options="fit:true,border:true">
     <c:forEach items="${menuLists}" var="menu">
        <c:if test="${menu.hasMenu}">
            <div title="${menu.menuName }" data-options="selected:true,iconCls:'icon-cloud'" style="overflow:auto;padding:6px;">
...
<div region="south" style="height: 25px;padding: 5px" align="center">
   杭州电子科技大学教育部检测仪表与自动化系统集成技术工程研究中心  杭州正安科技有限公司  联系电话：13867416018</div>
