...
<body>
	...
	<div class="easyui-tabs" fit="true" id="tabs">
		<c:forEach items="${factoryInfoList}" var="facCurInfo">
			<!-- 获取某工厂的系统 ：${facSystem.sysId}+${facSystem.sysName}+sysImageUrl?sysImageUrl=${facSystem.sysImageUrl}-->
			<c:choose>
				...
				<c:otherwise>
					<a
						href="javascript:openTab('${facCurInfo.systemName}','systemHistory.html?modelName=tb2_model${facCurInfo.modelNum}&modelId=${facCurInfo.modelId}')"
