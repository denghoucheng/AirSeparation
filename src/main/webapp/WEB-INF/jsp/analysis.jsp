...
<script type="text/javascript">
	 ...
	 * 打开标签页
	 */
	function openTab(tabName, url, iconCls) {
		console.log(url);
...
<body>
	<div id="tabs" class="easyui-tabs" fit="true">
		<a href="javascript:openTab('${jsonObject.json1}','dailyReport.html?factoryId=${jsonObject.factoryId}')"
			class="easyui-linkbutton" data-options="plain:true" id="btn">${jsonObject.json1}</a>
		<a href="javascript:openTab('${jsonObject.json2}','analysisHistory.html?factoryId=${jsonObject.factoryId}')"
			class="easyui-linkbutton" data-options="plain:true" id="btn">${jsonObject.json2}</a>
	</div>
</body>
</html>